...
export const generateToken = (userId,res) => {
    ...
    res.cookie("jwt",token,{
        ...
        sameSite: process.env.NODE_ENV === "production" ? "none" : "strict", //CSRF attacks cross-site request forgery attcks
        secure: process.env.NODE_ENV === "production" //use secure cookies in development
    });
